...
function Teamlead_profile() {
    ...
    useEffect(() => {
        ...
        axios.get("http://127.0.0.1:8000/teamlead_profile/", {headers})
            .then(response => {
  ...
  return (
    <main className='main-container'>
      ...
      <div className="card">
        ...
        <p>{department}</p>
        <p>
          <Link to="/edit_tl_profile"><button>Edit</button></Link>
        </p>
        <p>
...
export default Teamlead_profile